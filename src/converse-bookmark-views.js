        ...
        ChatRoomView: {
            getHeadingButtons () {
                ...
                if (_converse.allow_bookmarks) {
                    ...
                    const data = {
                        'i18n_title': this.model.get('bookmarked') ? __('Unbookmark this groupchat') : __('Bookmark this groupchat'),
                        'i18n_text': this.model.get('bookmarked') ? __('Unbookmark') : __('Bookmark'),
